...
@AutoMappr([
  ...
  MapType<ch.Response<List<raw.Int32StatCount>>,
      KavitaResponse<List<StatCount<int>>>>(),
  MapType<ch.Response<List<raw.TopReadDto>>,
      KavitaResponse<List<TopReadDto>>>(),
  MapType<raw.UserDto, UserDto>(reverse: true),
  MapType<ch.Response<raw.ServerStatisticsDto>,
      KavitaResponse<ServerStatisticsDto>>(),
  MapType<ch.Response<raw.UserReadStatistics>,
      KavitaResponse<UserReadStatistics>>(),
  MapType<ch.Response<List<raw.PublicationStatusStatCount>>,
      KavitaResponse<List<StatCount<PublicationStatus>>>>(),
  MapType<ch.Response<List<raw.MangaFormatStatCount>>,
      KavitaResponse<List<StatCount<MangaFormat>>>>(),
  MapType<ch.Response<List<raw.FileExtensionBreakdownDto>>,
      KavitaResponse<List<FileExtensionBreakdownDto>>>(),
  MapType<ch.Response<List<raw.DayOfWeekStatCount>>,
      KavitaResponse<List<StatCount<DayOfWeek>>>>(),
  MapType<ch.Response<List<raw.DateTimePagesReadOnADayCount>>,
  ...
  MapType<raw.UserReadStatistics, UserReadStatistics>(),
  MapType<raw.ServerStatisticsDto, ServerStatisticsDto>(),
  MapType<raw.SingleStatCount, StatCount<double>>(),
  MapType<raw.SeriesDtoICount, StatCount<SeriesDto>>(),
  MapType<raw.UserDtoICount, StatCount<UserDto>>(),
  MapType<raw.LibraryDtoICount, StatCount<LibraryDto>>(),
  MapType<raw.Int32StatCount, StatCount<int>>(),
  MapType<raw.PublicationStatusStatCount, StatCount<PublicationStatus>>(),
  MapType<raw.MangaFormatStatCount, StatCount<MangaFormat>>(),
  MapType<raw.TopReadDto, TopReadDto>(),
  MapType<raw.FileExtensionBreakdownDto, FileExtensionBreakdownDto>(),
  MapType<raw.FileExtensionDto, FileExtensionDto>(),
  MapType<raw.DateTimePagesReadOnADayCount, PagesReadOnADayCount<DateTime>>(
    converters: [
      TypeConverter<int, MangaFormat>(MangaFormat.new),
    ],
  ),
